        ...
        MTFrame {
            header: MTHeader {
                ...
                command: CommandCode {
                    ...
                    cmd_type: CommandType::AREQ,
                    subsystem: MTSubsystem::MAC,
                    id: MACCommandId::PurgeCnf as u8,
                },
            },
            extended_header: None,
            payload: self.encode(),
        ...
        MTFrame {
            header: MTHeader {
                ...
                command: CommandCode {
                    ...
                    cmd_type: CommandType::AREQ,
                    subsystem: MTSubsystem::MAC,
                    id: MACCommandId::WSAsyncInd as u8,
                },
            },
            extended_header: None,
            payload: self.encode(),
        ...
        MTFrame {
            header: MTHeader {
                ...
                command: CommandCode {
                    ...
                    cmd_type: CommandType::AREQ,
                    subsystem: MTSubsystem::MAC,
                    id: MACCommandId::SyncLossInd as u8,
                },
            },
            extended_header: None,
            payload: self.encode(),
        ...
        MTFrame {
            header: MTHeader {
                ...
                command: CommandCode {
                    ...
                    cmd_type: CommandType::AREQ,
                    subsystem: MTSubsystem::MAC,
                    id: MACCommandId::AssociateInd as u8,
                },
            },
            extended_header: None,
            payload: self.encode(),
        ...
        MTFrame {
            header: MTHeader {
                ...
                command: CommandCode {
                    ...
                    cmd_type: CommandType::AREQ,
                    subsystem: MTSubsystem::MAC,
                    id: MACCommandId::AssociateCnf as u8,
                },
            },
            extended_header: None,
            payload: self.encode(),
        ...
        MTFrame {
            header: MTHeader {
                ...
                command: CommandCode {
                    ...
                    cmd_type: CommandType::AREQ,
                    subsystem: MTSubsystem::MAC,
                    id: MACCommandId::BeaconNotifyInd as u8,
                },
            },
            extended_header: None,
            payload: self.encode(),
        ...
        MTFrame {
            header: MTHeader {
                ...
                command: CommandCode {
                    ...
                    cmd_type: CommandType::AREQ,
                    subsystem: MTSubsystem::MAC,
                    id: MACCommandId::DisassociateInd as u8,
                },
            },
            extended_header: None,
            payload: self.encode(),
        ...
        MTFrame {
            header: MTHeader {
                ...
                command: CommandCode {
                    ...
                    cmd_type: CommandType::AREQ,
                    subsystem: MTSubsystem::MAC,
                    id: MACCommandId::DisassociateCnf as u8,
                },
            },
            extended_header: None,
            payload: self.encode(),
        ...
        MTFrame {
            header: MTHeader {
                ...
                command: CommandCode {
                    ...
                    cmd_type: CommandType::AREQ,
                    subsystem: MTSubsystem::MAC,
                    id: MACCommandId::OrphanInd as u8,
                },
            },
            extended_header: None,
            payload: self.encode(),
        ...
        MTFrame {
            header: MTHeader {
                ...
                command: CommandCode {
                    ...
                    cmd_type: CommandType::AREQ,
                    subsystem: MTSubsystem::MAC,
                    id: MACCommandId::CommStatusInd as u8,
                },
            },
            extended_header: None,
            payload: self.encode(),
        ...
        MTFrame {
            header: MTHeader {
                ...
                command: CommandCode {
                    ...
                    cmd_type: CommandType::AREQ,
                    subsystem: MTSubsystem::MAC,
                    id: MACCommandId::StartCnf as u8,
                },
            },
            extended_header: None,
            payload: self.encode(),
        ...
        MTFrame {
            header: MTHeader {
                ...
                command: CommandCode {
                    ...
                    cmd_type: CommandType::AREQ,
                    subsystem: MTSubsystem::MAC,
                    id: MACCommandId::WSAsyncCnf as u8,
                },
            },
            extended_header: None,
            payload: self.encode(),
